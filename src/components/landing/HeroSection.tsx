...
export function HeroSection() {
    return (
        <>
                ...
                <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center w-full">
                    ...
                    <div className="space-y-8 text-center lg:text-left z-10">
                        ...
                        <p className="text-lg md:text-xl text-slate-400 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                            Orbi is the perfect place for <span className="text-white font-semibold">IIM Sambalpur</span> students to game, chill, and connect.
                            Build your community in a space designed for real interaction.Built Solo by Amish sharma 
                        </p>
            ...
            <footer className="w-full py-4 bg-black bg-opacity-80 text-center text-xs text-slate-400 absolute bottom-0 left-0 z-20">
