...
exports.createUsername = functions.https.onCall(async (data, context) => {
    ...
    const lowerUsername = username.toLowerCase();
    const lowerOldUsername = oldUsername === null || oldUsername === void 0 ? void 0 : oldUsername.toLowerCase();
    try {
        ...
        const result = await db.runTransaction(async (transaction) => {
            ...
            if (newUsernameDoc.exists && ((_a = newUsernameDoc.data()) === null || _a === void 0 ? void 0 : _a.uid) !== uid) {
            ...
            if (lowerOldUsername && lowerOldUsername !== lowerUsername) {
                ...
                if (oldUsernameDoc.exists && ((_b = oldUsernameDoc.data()) === null || _b === void 0 ? void 0 : _b.uid) === uid) {
        ...
        throw new functions.https.HttpsError('internal', error instanceof Error ? error.message : 'Failed to create username mapping');
    }
});
/**
 ...
 */
exports.resolveUsername = functions.https.onRequest(async (req, res) => {
    var _a;
    // Set CORS headers
 ...
 */
function isAdmin(uid, customClaims) {
    // Check against hardcoded list
    if (ADMIN_UIDS.includes(uid)) {
        return true;
    }
    // Check custom claims
    if ((customClaims === null || customClaims === void 0 ? void 0 : customClaims.admin) === true) {
        return true;
    }
    return false;
}
...
exports.createPost = functions.https.onCall(async (data, context) => {
    ...
    const uid = context.auth.uid;
    const { caption, isAnonymous = false, mediaUrl = null, mediaUrls = null, mediaType = null, imageHint = null, embed = null } = data;
    // Validate caption
    if (!caption && !mediaUrl && !(mediaUrls === null || mediaUrls === void 0 ? void 0 : mediaUrls.length) && !embed) {
    ...
    if (!checkPostRateLimit(uid)) {
        throw new functions.https.HttpsError('resource-exhausted', 'Rate limit exceeded. You can create up to 10 posts per hour.');
    }
    try {
        ...
        if (isAnonymous) {
            ...
            postData.userId = uid;
            postData.username = (userData === null || userData === void 0 ? void 0 : userData.username) || 'user';
            postData.authorDisplayName = (userData === null || userData === void 0 ? void 0 : userData.displayName) || 'User';
            postData.authorPhotoURL = (userData === null || userData === void 0 ? void 0 : userData.photoURL) || `https://picsum.photos/seed/${uid}/200/200`;
        ...
        throw new functions.https.HttpsError('internal', error instanceof Error ? error.message : 'Failed to create post');
    }
});
/**
 ...
 */
exports.revealAuthor = functions.https.onCall(async (data, context) => {
    // Check authentication
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    ...
    if (!isAdmin(uid, customClaims)) {
        throw new functions.https.HttpsError('permission-denied', 'Only administrators can reveal anonymous post authors');
    }
    const { postId } = data;
    if (!postId) {
    ...
    try {
        ...
        const userDoc = await db.doc(`users/${privateData === null || privateData === void 0 ? void 0 : privateData.realAuthorId}`).get();
        const userData = userDoc.exists ? userDoc.data() : null;
        return {
            postId: postId,
            realAuthorId: privateData === null || privateData === void 0 ? void 0 : privateData.realAuthorId,
            realAuthorUsername: (userData === null || userData === void 0 ? void 0 : userData.username) || 'unknown',
            realAuthorDisplayName: (userData === null || userData === void 0 ? void 0 : userData.displayName) || 'Unknown User',
            realAuthorEmail: (userData === null || userData === void 0 ? void 0 : userData.email) || null,
            isAnonymous: privateData === null || privateData === void 0 ? void 0 : privateData.isAnonymous,
            createdAt: privateData === null || privateData === void 0 ? void 0 : privateData.createdAt,
        };
    }
    catch (error) {
        ...
        throw new functions.https.HttpsError('internal', error instanceof Error ? error.message : 'Failed to reveal author');
    }
});
/**
    ...
    try {
        ...
        const result = await db.runTransaction(async (transaction) => {
            ...
            if (followerSnap.exists) {
                ...
                const newTargetFollowers = Math.max(((targetUserData === null || targetUserData === void 0 ? void 0 : targetUserData.followersCount) || 0) - 1, 0);
                const newCurrentFollowing = Math.max(((currentUserData === null || currentUserData === void 0 ? void 0 : currentUserData.followingCount) || 0) - 1, 0);
                // Update user counts
                ...
                const newTargetFollowers = ((targetUserData === null || targetUserData === void 0 ? void 0 : targetUserData.followersCount) || 0) + 1;
                const newCurrentFollowing = ((currentUserData === null || currentUserData === void 0 ? void 0 : currentUserData.followingCount) || 0) + 1;
                // Update user counts
                transaction.update(targetUserRef, { followersCount: newTargetFollowers });
                transaction.update(currentUserRef, { followingCount: newCurrentFollowing });
                return {
        ...
        throw new functions.https.HttpsError('internal', error instanceof Error ? error.message : 'Failed to toggle follow');
    }
});
/**
 ...
 */
exports.initializeUserCounts = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        throw new functions.https.HttpsError('internal', error instanceof Error ? error.message : 'Failed to initialize user counts');
    }
});
/**
 ...
 */
exports.getFollowersForUI = functions.https.onCall(async (data, context) => {
    // Check authentication
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    ...
    try {
        ...
        const items = followers.map((followerDoc, index) => {
            ...
            return {
                ...
                profilePicture: (userData === null || userData === void 0 ? void 0 : userData.profilePicture) || '',
        ...
        throw new functions.https.HttpsError('internal', error instanceof Error ? error.message : 'Failed to get followers');
    }
});
 ...
 */
async function deleteFromCloudinary(publicId, cloudName, resourceType) {
    let apiKey, apiSecret;
 ...
 */
exports.onStoryDelete = functions.firestore.document('stories/{storyId}').onDelete(async (snap, context) => {
    const data = snap.data();
    if (data && data.publicId && data.cloudName) {
